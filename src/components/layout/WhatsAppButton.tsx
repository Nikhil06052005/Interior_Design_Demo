...
export function WhatsAppButton() {
  ...
  const url = `https://wa.me/91${contact.phone}?text=${message}`;
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 transition-transform hover:scale-110 active:scale-95 md:bottom-6"
    >
