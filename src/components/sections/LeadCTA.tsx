          ...
          <div className="grid lg:grid-cols-2">
            ...
            >
              ...
              <div className="mt-5 space-y-3 md:mt-8 md:space-y-4">
                ...
                <a href={`mailto:${contact.email}`} className="flex items-center gap-3 text-white/90 hover:text-white">
                  <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10">
                ...
                <a href={contact.mapLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-white/90 hover:text-white">
                  <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10">
